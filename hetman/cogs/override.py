...
Typical usage example:
    ...
    await bot_instance.load_extension("hetman.cogs.override")
    ```
"""
# License: EPL-2.0
...
class Overrides(commands.GroupCog,
    ...
    def __init__(self, bot_instance: bot.Hetman):
        """Initializes the cog.
    ...
    async def reload(self,
        ...
        if sync:
            ...
            dev_guild = self._bt.get_guild(_CNFG["dev_guild_id"])
...
async def setup(bot_instance: bot.Hetman):
