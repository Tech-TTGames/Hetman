...
This file contains constants for the bot.
It is used to store constants that are used in multiple places.
...
pathlib.Path(PROG_DIR, "log").mkdir(parents=True, exist_ok=True)
...
COLORS = {
    ...
    "gray": discord.Color.lighter_grey(),
